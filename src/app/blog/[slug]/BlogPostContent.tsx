      ...
      <main className="bg-white">
        ...
        {post.featuredImage && (
          <div className="relative w-full bg-gray-200 overflow-hidden" style={{ height: 'calc(100dvh - 67px)' }}>
            <img
              src={optimizeCloudinaryUrl(post.featuredImage, 1920)}
              srcSet={cloudinarySrcSet(post.featuredImage, 1920)}
              alt={post.title}
              ...
              <div className="flex-shrink-0">
                <div className="w-24 h-24 sm:w-36 sm:h-36 bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center text-white font-bold text-2xl sm:text-3xl overflow-hidden">
                  {authorProfile?.avatarUrl ? (
                    <img
                      src={optimizeCloudinaryUrl(authorProfile.avatarUrl, 200)}
                      srcSet={cloudinarySrcSet(authorProfile.avatarUrl, 200)}
                      alt={post.author}
                  ...
                  <Link key={relatedPost.id} href={`/blog/${relatedPost.slug}`} className="overflow-hidden group">
                    {relatedPost.featuredImage && (
                      <div className="relative w-full aspect-square bg-gray-200 overflow-hidden">
                        <img
                          src={optimizeCloudinaryUrl(relatedPost.featuredImage, 800)}
                          srcSet={cloudinarySrcSet(relatedPost.featuredImage, 800)}
