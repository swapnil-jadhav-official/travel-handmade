// Static newsletter data -- to be replaced with Firestore when DB is connected.
// Schema mirrors what will be stored in the 'newsletters' collection.
...
export interface NewsletterIssue {
  ...
  slug: string;
  issueNumber: number;
  title: string;          // e.g. "The Mindful Traveller"
  description: string;    // one-liner shown in the listing
  accentColor: string;    // cover card background hex
  coverThumbnail: string; // photo shown on listing card
  heroImage: string;      // full-bleed cover image on detail page
  editorLetterParagraphs: string[];
  // If set, pull quote is inserted after this many paragraphs (splits letter into two blocks)
  pullQuoteAfterIndex?: number;
  pullQuote: string;
  editorName: string;
  editorTitle: string;
...
// ---------------------------------------------------------------------------
// Images -- replace with permanent assets once DB + Cloudinary upload is wired.
// ---------------------------------------------------------------------------
const IMG_FOREST =
  'https://www.figma.com/api/mcp/asset/72ce7357-a55e-425f-90ee-28cbab4dc95c';
const IMG_VENICE =
  'https://www.figma.com/api/mcp/asset/a31b5e7f-07e0-47d3-b7de-2b06e59dfebf';
const IMG_SAFARI =
  'https://www.figma.com/api/mcp/asset/a0e6aab9-87f8-4fce-bd65-7fb63e6c21b6';
const IMG_MOUNTAIN =
  'https://www.figma.com/api/mcp/asset/cf760b31-44ce-479b-bb13-8d991a84192f';
const IMG_HOTEL_COVER =
  'https://www.figma.com/api/mcp/asset/377d47c7-65b9-4fdd-a162-144aa6c78e78';
const IMG_BORNEO =
  'https://www.figma.com/api/mcp/asset/fb545a25-304f-4762-b58f-5e2dd3e7ec43';
const IMG_LADAKH =
  'https://www.figma.com/api/mcp/asset/88e4b6a8-ab09-4ca9-bef4-b557ef9077b6';
const IMG_ATHENS =
  'https://www.figma.com/api/mcp/asset/219d4fbe-8af2-4360-8734-4a204fbb680e';
    ...
    articles: [
      {
        ...
        author: 'Ben Richards',
        title: "A Craft Trail Around Japan's Saga Prefecture",
        image: IMG_FOREST,
      },
      {
        id: 'a2',
        ...
        author: 'Priya Menon',
        title: 'Sixteen Months on the Open Ocean',
        image: IMG_VENICE,
      },
      {
        id: 'a3',
        category: 'WELLNESS',
        author: 'Ananya Das',
        title: 'Transformation in Mayakoba',
        image: IMG_SAFARI,
      },
      {
        id: 'a4',
        category: 'RETREATS',
        author: 'Marcus Webb',
        title: 'Grounding in the Brazilian Cerrado',
        image: IMG_MOUNTAIN,
      },
    ],
    ...
    articles: [
      {
        ...
        category: 'TRAVEL + LIVING',
        author: 'Divya Nair',
        title: 'Venice After the Crowds Leave',
        image: IMG_VENICE,
      },
      {
        id: 'a2',
        ...
        author: 'Kiran Bose',
        title: 'A Market Walk Through Oaxaca',
        image: IMG_FOREST,
      },
      {
        id: 'a3',
        ...
        author: 'Leila Hassan',
        title: 'The Artist Who Paints Only From Memory',
        image: IMG_SAFARI,
      },
      {
        id: 'a4',
        category: 'WELLNESS',
        author: 'Arun Varma',
        title: 'On Slowing Down in the Dolomites',
        image: IMG_MOUNTAIN,
      },
    ],
    ...
    articles: [
      {
        ...
        category: 'ADVENTURE + WILDLIFE',
        author: 'Riyanka Roy',
        title: 'On Safari in Amboseli: Beyond the Big Five',
        image: IMG_SAFARI,
      },
      {
        id: 'a2',
        category: 'TRAVEL + LIVING',
        author: 'Shreya Patel',
        title: 'A Ferry Through the Greek Islands',
        image: IMG_VENICE,
      },
      {
        id: 'a3',
        ...
        title: 'Tea Ceremonies Along the Silk Road',
        image: IMG_FOREST,
      },
      {
        id: 'a4',
        ...
        title: 'A Working Ranch in Patagonia',
        image: IMG_MOUNTAIN,
      },
    ],
    ...
    articles: [
      {
        ...
        title: 'Learning to Weave in the Atlas Mountains',
        image: IMG_MOUNTAIN,
      },
      {
        id: 'a2',
        category: 'FOOD + DRINKS',
        author: 'Yuki Tanaka',
        title: "A Ramen Master's Apprentice",
        image: IMG_FOREST,
      },
      {
        id: 'a3',
        ...
        title: 'Craft Schools Saving a Dying Tradition',
        image: IMG_SAFARI,
      },
      {
        id: 'a4',
        category: 'ADVENTURE + WILDLIFE',
        author: 'Sven Larsson',
        title: 'Hand-Built and Seaworthy: A Voyage from Norway',
        image: IMG_VENICE,
      },
    ],
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        title: "A Cultural Guide to Athens: The City's Creative Revival",
        image: IMG_ATHENS,
        articleSlug: '',
      },
      {
        ...
        category: 'ADVENTURE + WILDLIFE',
        author: 'Riyanka Roy',
        title: "Why Amboseli National Park is Becoming A Traveller's Favourite",
        image: IMG_SAFARI,
        articleSlug: '',
      },
      {
        id: 'a4',
        category: 'ADVENTURE + WILDLIFE',
        author: 'Sinchita Sinha',
        title: 'I Took A Night Walking Tour in the Jungles of Borneo',
        image: IMG_BORNEO,
        articleSlug: '',
      },
    ],
