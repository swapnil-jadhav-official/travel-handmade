...
export default function BlogContent({ html, articleType = 'listicle' }: BlogContentProps) {
  ...
  return (
    <div
      ref={contentRef}
      className={`prose max-w-none mb-12 [&_p:empty]:min-h-4 [&_p]:text-sm [&_p]:font-[family-name:var(--font-work-sans)] [&_p]:leading-[1.61] [&_h1]:text-2xl [&_h2]:text-xl [&_h3]:text-lg [&_figure]:my-6${galleryStyles}`}
